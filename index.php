...
<!-- 		<p> hello</p>
 ...
 -->
 			...
 			<div class="row">
				...
				<h1>hello. welcome to the <span class="sl">spotless leopard</span>.</h1>
				</div>
				<div class="col-md-3">
<!-- 								<p><button type="button" class="btn btn-default btn-lg">Next pop-up</button></p>
 ...
 -->
		...
		<video autoplay preload muted class="fillWidth">
			<source src="<?php bloginfo('template_url'); ?>/inc/video/spotlesscake.mp4" type="video/mp4" />Your browser does not support the video tag. I suggest you upgrade your browser.
		</video>
