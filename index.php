...
<div class="homepage-hero-module">
	<div class="video-container">
					...
					<div class="col-md-6">
						<div class="headline">
			               	<!-- <h1>Welcome to our Company</h1> -->
								<h1>hello.<br/>the <span class="sl">spotless leopard</span> is a food truck serving vegan goodness to the people of bristol. we also have regular pop-up restaurants at various locations across the city.</h1>
								<p>
								...
								<p><img src="<?php bloginfo('template_url'); ?>/inc/img/twitter.png" height="40px">
								<img src="<?php bloginfo('template_url'); ?>/inc/img/facebook.jpg" height="40px">
								<img src="<?php bloginfo('template_url'); ?>/inc/img/imgres.png" height="40px"></p>
			            </div>
		...
		<video autoplay preload muted class="fillWidth">
			<source src="<?php bloginfo('template_url'); ?>/inc/video/spotlesscake2.mp4" type="video/mp4" />Your browser does not support the video tag. I suggest you upgrade your browser.
		</video>
